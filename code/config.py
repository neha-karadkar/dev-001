...
class Config:
    ...
    # Only include relevant entries for LLM keys, content safety, observability DB, and agent identity.
    ...
    # Model configuration: sets for LLM kwargs compatibility
...
def _initialize_config():
    ...
    # All config variables required for this agent
    CONFIG_VARIABLES = [
        "ENVIRONMENT",
        "MODEL_PROVIDER",
        "LLM_MODEL",
